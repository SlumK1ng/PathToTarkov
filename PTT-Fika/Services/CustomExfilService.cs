...
{
    internal static class CustomExfilService
    {
        public static void ExtractTo(ExfiltrationPoint exfil, ExfilTarget exfilTarget)
        {
            LoggerPublic.Info($"(FIKA) started extraction on '{exfilTarget.GetCustomExitName()}'");
            ...
            if (coopGame == null)
            {
                LoggerPublic.Error($"(FIKA) cannot extract because no CoopGame found");
                return;
            }

            if (coopPlayer == null)
            {
                LoggerPublic.Error($"(FIKA) cannot extract because no CoopPlayer found");
                return;
            }
            ...
            if (IsHostPlayer())
            {
                TransitVoteService.SendDisableTransitVotePacket("Player host has extracted");
            }

            LoggerPublic.Info($"(FIKA) extraction done for profile {coopPlayer.ProfileId}");
        }
        ...
        public static void TransitTo(ExfilTarget exfilTarget)
        {
            ...
            LoggerPublic.Info($"started transit on '{exfilTarget.GetCustomExitName()}'");
            ...
            if (coopGame == null)
            {
                LoggerPublic.Error($"(FIKA) cannot transit because no CoopGame found");
                return;
            }

            if (coopPlayer == null)
            {
                LoggerPublic.Error($"(FIKA) cannot transit because no CoopPlayer found");
                return;
            }
            ...
            {
                LoggerPublic.Error($"(FIKA) cannot register the transit point");
                return;
            }
            ...
            LoggerPublic.Info($"(FIKA) transit done for profile '{coopPlayer.ProfileId}'");
        }

        private static void DedicatedTransitTo(ExfilTarget exfilTarget)
        {
            LoggerPublic.Info($"(FIKA dedi) started dedicated transit on '{exfilTarget.GetCustomExitName()}'");
            ...
            if (coopGame == null)
            {
                LoggerPublic.Error($"(FIKA dedi) cannot transit because no CoopGame found");
                return;
            }

            if (coopPlayer == null)
            {
                LoggerPublic.Error($"(FIKA dedi) cannot transit because no CoopPlayer found");
                return;
            }
            ...
            if (!RegisterTransitPoint(transit))
            {
                LoggerPublic.Error($"(FIKA dedi) cannot register the transit point");
                return;
            }
            ...
            {
                LoggerPublic.Warning($"(FIKA dedi) cannot set FikaBackendUtils.IsTransit to true");
            }
            ...
            LoggerPublic.Info($"(FIKA) transit done for dedicated client");
        }
        ...
        private static bool RegisterTransitPoint(TransitPoint transit)
        {
            ...
            if (gameWorld == null)
            {
                LoggerPublic.Error($"(FIKA) cannot register transit point because no GameWorld found");
                return false;
            }

            if (localRaidSettings == null)
            {
                LoggerPublic.Error($"(FIKA) cannot register transit point because no LocalRaidSettings found");
                return false;
            }

            if (coopPlayer == null)
            {
                LoggerPublic.Error($"(FIKA) cannot register transit point because no CoopPlayer found");
                return false;
            }

            if (transitController == null)
            {
                LoggerPublic.Error($"(FIKA) cannot register transit point because no transitController found");
                return false;
            }
            ...
            {
                LoggerPublic.Error($"(FIKA) cannot register transit point because no TarkovApplication found");
                return false;
            }
        ...
        private static TransitControllerAbstractClass GetTransitController()
        {
            ...
            if (gameWorld == null)
            {
                LoggerPublic.Error($"(FIKA) no GameWorld found");
                return null;
            }
        ...
        private static TransitControllerAbstractClass CreateTransitController(Profile profile)
        {
            ...
            if (localRaidSettings == null)
            {
                LoggerPublic.Error($"(FIKA) cannot retrieve the fika transit controller because no LocalRaidSettings found");
                return null;
            }

            if (localSettings == null)
            {
                LoggerPublic.Error($"(FIKA) cannot retrieve the fika transit controller because no LocalSettings found");
                return null;
            }

            if (localSettings.locationLoot == null)
            {
                LoggerPublic.Warning($"(FIKA) LocalSettings.locationLoot is null");
            }

            if (backendConfigSettings?.transitSettings == null)
            {
                LoggerPublic.Error($"(FIKA) cannot retrieve the fika transit controller because no BackendConfigSettingsClass.transitSettings found");
                return null;
            }

            LocationSettingsClass.Location.TransitParameters[] transitParameters = localSettings.locationLoot?.transitParameters ?? new LocationSettingsClass.Location.TransitParameters[0];
        ...
        // Helper methods
        private static bool IsHostPlayer() => FikaBridge.IsHostPlayer();
        private static bool IsDedicated() => FikaBridge.IsDedicated();
    }
}